        ...
        <main id="main" className="page Accordion-page">
            ...
            <section className="section">
                <div className="section-content">
                    <h2>Learn more about the In Control of Effects Project</h2>
                    <p>On this page, you can find out more about the project, how to use the application, what to do with the results, and other information. If you additional questions or would like more information, please contact the study coordinator.</p>
                </div>
            </section>
            <section className="section">
                <div className="section-content">
                    <h2>About the In Control of Effects project</h2>
                    ...
                    <Accordion id="is-the-in-control-of-effects-app-part-of-a-research-study" title="Is the In Control of Effects app part of a research study?">
                        <p>Yes, the app is part of ongoing research led by researchers at the University of Oxford.</p>
                    </Accordion>
                    <Accordion id="who-is-running-the-research-project" title="Who is running the research project?">
                        <p>This research project is led by researchers at the University of Oxford in the Department of Psychiatry.</p>
                    </Accordion>
                </div>
            </section>
            <section className="section">
                <div className="section-content">
                    ...
                    <Accordion id="do-i-have-to-install-the-app-on-my-phone" title="Do I have to install the app on my phone?">
                        <p>No installation is required to run the app. The <strong>In Control of Effects</strong> app is completely web-based meaning you can access it like any other web page.</p>
                    </Accordion>
                    <Accordion id="how-can-i-access-the-app" title="How can I access the app?">
                        <p>You may use any computer, tablet or smartphone to access the app. You may use any web browser you like. A username and password is required. See the next question for more information.</p>
                    </Accordion>
                    ...
                    <Accordion id="how-do-i-get-an-account" title="How do I get an account?">
                        <p>Accounts are given out by the study coordinator to those who are part of the research project. Each account is will expire after a certain period time or if the max number of times the app is accessed whichever comes first. See the question [Do I need an account to use the app?](#do-i-need-an-account-to-use-the-app) for more information.</p>
                    </Accordion>
                    <Accordion id="i-am-having-troubles-signing-in-what-do-i-do" title="I am having troubles signing in. What do I do?">
                        <p>The sign in form is designed to return an error if the username or password is incorrect or if something is missing. Make sure the information is typed correctly and there are no extra spaces. All accounts are set to expire after an amount of time. It is also possible that the account might be expired. An error message will be display informing you that the account is expired. Contact the study coordinator if this is the case.</p>
                    </Accordion>
                </div>
            </section>
            <section className="section">
                <div className="section-content">
                    ...
                    <Accordion id="how-do-i-navigate-the-app" title="How do I navigate the app?">
                        <p>On each page, there will two buttons at the bottom of the page. These buttons will be labelled **previous** and **next**. Clicking or tapping the previous button will move you to the previous page. The next page button will bring you to the next page. At times, the next button will be replaced with a submit button. If this is the case, tap or click the submit button to move to the next page.</p>
                    </Accordion>
                    <Accordion id="how-do-i-select-side-effects" title="How do I select side effects?">
                        <p>You can select side effects by tap or click the name of the side effect a single time. You may select up to two side effects and you must select at least one side effect. A message will be displayed if there are any issues during selection. Tap or click the name of a side effect a second time to deselect it.</p>
                    </Accordion>
                    <Accordion id="how-do-i-know-if-a-side-effect-is-selected" title="How do I know if a side effect is selected?">
                        <p>Selected side effects will change in appearance. If you selected a side effect, the background color will darken and a checkmark will appear next to the name of the side effect indicating it is selected.</p>
                    </Accordion>
                    ...
                    <Accordion id="how-can-i-learn-more-about-a-medication" title="How can I learn more about a medication?">
                        <p>The results page will show several medications. Each medication is also a button. To learn more about a medication, click the name of medication and you will brought to a new screen. This new screen will display information on why the medication was selected.</p>
                    </Accordion>
                    <Accordion id="can-i-startover" title="Can I startover?">
                        <p>Of course! There's a restart button located at the top of the screen. Tap or click this button at any time to restart the app. This won't sign you out, it will bring you to the first page of the app.</p>
                    </Accordion>
                    ...
                    <Accordion id="can-i-save-the-results" title="Can I save or print the results?">
                        <p>Not at this time. A feature for saving or printing the results is on the *wish list*, but there are no immediate plans. We recommend that you take note of the side effects that you selected or the results. Alternatively, you can take screenshots of each page.</p>
                    </Accordion>
                </div>
            </section>
        </main>
