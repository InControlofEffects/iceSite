...
const background = (props) => {
    const css = this.props.css ? `logo ${this.props.css}` : "logo";
    return (
        <svg width="1024px" height="209px" viewBox="0 0 1024 209" version="1.1" xmlns="http://www.w3.org/2000/svg">
